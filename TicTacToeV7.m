%This program is a text-based version of tic tac toe
%You can play either another person or against the computer
...
%Displaying the score for games played against two people
if strcmp(playerOrComputer,"p") == 1
    fprintf("Player 1's Games Won: %d\n",playerOneScore);
    fprintf("Player 2's Games Won: %d\n",playerTwoScore);
end
...
while strcmp(playerOrComputer,"c") == 1 && playAgain == 1
    displayBoard(board);
    if player == 1
        row = input('Enter the row you want to put your move: ');
        column = input('Enter the column you want to put your move:');
...
%Displaying the score for games played against a person and the computer
if strcmp(playerOrComputer,"c") == 1
    fprintf("Player 1's Games Won: %d\n",playerOneScore);
    fprintf("Computer's Games Won: %d\n",computerScore);
end
